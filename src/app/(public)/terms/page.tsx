      ...
      <div className='flex flex-col gap-2 justify-center items-center'>
        ...
        <div className='flex flex-col w-full max-w-lg gap-4'>
          <p>
            ...
            use of RateMyPlate&apos;s Website, located at{' '}
            <a
          ...
          <p>
            ...
            conditions. Do not continue to use RateMyPlage if you do not agree
          ...
          <p>
            We employ the use of cookies. By accessing RateMyPlage, you agreed
            to use cookies in agreement with the RateMyPlate&apos;s Privacy
            Policy.{' '}
          </p>
          <p>
          ...
          <p>
            Unless otherwise stated, RateMyPlate and/or its licensors own the
            intellectual property rights for all material on RateMyPlage. All
            intellectual property rights are reserved. You may access this from
            RateMyPlage for your own personal use subjected to restrictions set
            in these terms and conditions.
          </p>
          <p>You must not:</p>
          <ul className='list-disc list-inside pl-5'>
            <li>Republish material from RateMyPlage</li>
            <li>Sell, rent or sub-license material from RateMyPlage</li>
            <li>Reproduce, duplicate or copy material from RateMyPlage</li>
            <li>Redistribute content from RateMyPlage</li>
          </ul>
          <p>
          ...
          <p>
            ...
            RateMyPlate does not filter, edit, publish or review Comments prior
            to their presence on the website. Comments do not reflect the views
            and opinions of RateMyPlate,its agents and/or affiliates. Comments
            reflect the views and opinions of the person who post their views
            and opinions. To the extent permitted by applicable laws,
            RateMyPlate shall not be liable for the Comments or for any
          ...
          <p>
            RateMyPlate reserves the right to monitor all Comments and to remove
          ...
          <p>
            You hereby grant RateMyPlate a non-exclusive license to use,
          ...
          <p>
            ...
            visibility of the hyperlink compensates the absence of RateMyPlate;
          ...
          <p>
            ...
            sending an e-mail to RateMyPlate. Please include your name, your
          ...
          <p>
            No use of RateMyPlate&apos;s logo or other artwork will be allowed
